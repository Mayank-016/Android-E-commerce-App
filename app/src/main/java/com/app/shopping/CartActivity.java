    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(CartActivity.this, "Total Price = "+String.valueOf(overTotalPrice), Toast.LENGTH_SHORT).show();
                amount = 0;
                amount = Math.round(Float.parseFloat(String.valueOf(overTotalPrice)))*100;
                ...
                try {
                    ...
                    options.put("prefill.email", "m-kart@example.com");
                    options.put("prefill.contact","9988998899");
